...
public class Customer2 {
    ...
    private Customer2(CustomerBuilder builder){
        this.id = builder.id;
    ...
    public Customer2(){
        Customer2 cust = new Customer2.CustomerBuilder().id().build();
        this.id = cust.getId();
    ...
    public Customer2(long id, String firstName, String lastName,
                     String email, String city, String state, String birthday){
        Customer2 cust = new Customer2.CustomerBuilder().id()
                .firstName(firstName)
                .lastName(lastName)
                .email(email)
                .city(city)
    ...
    public static class CustomerBuilder{
        ...
        public CustomerBuilder id(){
            this.id = Customer2.counter.getAndIncrement();
            return this;
        }
